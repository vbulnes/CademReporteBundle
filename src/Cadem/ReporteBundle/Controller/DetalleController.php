...
$tabla_resumen = array(
		'head' => array('SKU/SALA',
						...
						'JUMBO ANTOFAGASTA PA CERDA L796',
						'JUMBO BILBAO L501',
						'JUMBO CALAMA L614',
						'LIDER EXPRESS CALAMA INCA ORO L69',
						'LIDER HIPER LA REINA L95',
						'LIDER HIPER PUENTE ALTO L73',
						'TOTTUS ANTOFAGASTA MALL L15',
						'TOTTUS NATANIEL L12',
						'UNIMARC COPIAPO ATACAMA L22',
						),
		'body' => array(	
						array(
